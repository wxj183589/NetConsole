...
class DemoSiteSeedService:
    ...
    def _seed_devices(paths: PathResolver) -> None:
        ...
        devices = [
            ...
            Device(name="列车01-MR-CT", system_name="DEMO-MR01-CT", station="演示区间A-B", device_vendor="H3C", device_type="Other", primary_address="192.0.2.21", group_id=mr_group.id if mr_group else None, protocol="none", port=None, snmp_enabled=0, ssh_enabled=0, telnet_enabled=0, snmp_v1_enabled=0, snmp_v2c_enabled=0, remark="受控演示车载 MR，不可连接"),
            Device(name="列车01-MR-TC", system_name="DEMO-MR01-TC", station="演示区间A-B", device_vendor="H3C", device_type="Other", primary_address="192.0.2.22", group_id=mr_group.id if mr_group else None, protocol="none", port=None, snmp_enabled=0, ssh_enabled=0, telnet_enabled=0, snmp_v1_enabled=0, snmp_v2c_enabled=0, remark="受控演示车载 MR，不可连接"),
        ]
