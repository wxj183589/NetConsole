    ...
    def list_rows(
        ...
        *,
        ...
        return TracksideApBusinessPageDTO(
            ...
            fit_ap_switch_not_found_count=snapshot.fit_ap_switch_not_found_count,
            fit_ap_switch_identity_ambiguous_count=snapshot.fit_ap_switch_identity_ambiguous_count,
            fit_ap_switch_data_incomplete_count=snapshot.fit_ap_switch_data_incomplete_count,
            fit_ap_plan_not_found_count=snapshot.fit_ap_plan_not_found_count,
            fit_ap_plan_station_missing_count=snapshot.fit_ap_plan_station_missing_count,
            fit_ap_plan_station_invalid_count=snapshot.fit_ap_plan_station_invalid_count,
