...
from netconsole.services.trackside_ap_business import filter_trackside_ap_business_rows, trackside_row_status
    ...
    def list_rows(
        ...
        *,
        ...
        if optical_anomaly_only:
            enriched = [(row, severity) for row, severity in enriched if severity != "normal"]
        ...
        return TracksideApBusinessPageDTO(
            ...
            optical_abnormal_count=sum(trackside_row_status(row) != "normal" for row in snapshot.rows),
