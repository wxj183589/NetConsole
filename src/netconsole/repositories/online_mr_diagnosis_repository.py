        ...
        with sqlite3.connect(uri, uri=True) as conn:
            ...
            rows = conn.execute(
                ...
                SELECT DISTINCT
                    ...
                    resolved_peer_name, peer_ap_mac, canonical_ap_mac, peer_radio_mac,
                    identity_status, identity_source, identity_reason, identity_match_rule,
                    identity_match_confidence, bssid, mesh_interface, belong_station,
