...
AUTHORITY_STATES = frozenset({"LEGACY_AUTHORITY", "SHARD_VERIFIED", "SHARD_AUTHORITY", "SOURCE_DELETE_ELIGIBLE", "SOURCE_DELETED"})
SHARD_QUERY_AUTHORITY_STATES = frozenset({"SHARD_AUTHORITY", "SOURCE_DELETE_ELIGIBLE", "SOURCE_DELETED"})
