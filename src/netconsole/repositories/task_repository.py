...
class TaskRepository:
        ...
        *,
        ...
        cursor = conn.execute(
            ...
            INSERT INTO task_snapshots (
                ...
                result_path, error_message, result_json, source,
                trigger_source, parent_task_id, retry_of_task_id, recovery_source,
                site_name, owner_pid,
    ...
    def _snapshot_from_row(cls, row: dict[str, object]) -> TaskSnapshot:
        return TaskSnapshot(
            ...
            trigger_source=str(row.get("trigger_source") or "unknown"),
            parent_task_id=str(row.get("parent_task_id") or ""),
            retry_of_task_id=str(row.get("retry_of_task_id") or ""),
            recovery_source=str(row.get("recovery_source") or ""),
