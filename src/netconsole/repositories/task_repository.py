...
class TaskRepository:
    ...
    def enforce_terminal_history_retention(self) -> dict[str, object]:
        """Delegate terminal retention to the single cleanup owner."""

        from netconsole.services.job_center.task_cleanup_service import (
            TaskCleanupService,
        )

        return TaskCleanupService(self).cleanup_terminal_retention()
