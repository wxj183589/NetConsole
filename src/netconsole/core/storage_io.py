...
class StorageIOProfile:
    ...
    def fast(cls, *, source: str = "AUTO") -> "StorageIOProfile":
        return cls(
            ...
            db_batch_size=200, db_batch_interval_ms=500,
    ...
    def conservative(cls, *, source: str = "AUTO") -> "StorageIOProfile":
        return cls(
            ...
            db_batch_size=1000, db_batch_interval_ms=750,
            profile_source=source,
        )
        ...
        try:
            ...
            raw = self.command_runner(
                ["powershell", "-NoProfile", "-NonInteractive", "-Command",
                 ...
                 "Select-Object Number,FriendlyName,BusType,MediaType,Model,OperationalStatus,UniqueId | "
