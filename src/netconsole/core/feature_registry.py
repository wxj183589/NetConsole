...
FEATURES: tuple[FeatureItem, ...] = (
    ...
    FeatureItem("web.train_communication_monitoring", "在线列车车内通信检测", "module.rail_transit", "page"),
    FeatureItem(
    ...
    FeatureItem("web.rail_car_network_diagnostic_execute", "在线列车车内通信检测执行（Web）", "web.train_communication_monitoring", "action"),
