...
FEATURES: tuple[FeatureItem, ...] = (
    ...
    FeatureItem("web.file_management_remote", "设备文件浏览与下载（Web）", "web.file_management", "action"),
    FeatureItem("web.file_management_desktop_actions", "文件桌面联动（Web）", "web.file_management", "action"),
    ...
    FeatureItem("web.ac_dangerous_actions", "AC 高风险动作真实闭环（Web）", "web.ac_management", "action"),
    FeatureItem(
    ...
    FeatureItem("web.mesh_ap_coverage_audit", "MESH AP 覆盖核查（Web）", "web.mesh_analysis", "action"),
    ...
    FeatureItem("web.rail_train_online_mapping_write", "列车 MR 映射保存（Web）", "web.rail_train_online", "action"),
    FeatureItem("web.rail_train_online_mapping_import", "列车 MR 映射导入（Web）", "web.rail_train_online", "action"),
    FeatureItem("web.rail_train_online_mapping_export", "列车 MR 映射模板导出（Web）", "web.rail_train_online", "action"),
    FeatureItem(
    ...
    FeatureItem("web.rail_car_network_diagnostic_execute", "车内通信检测执行（Web）", "web.train_communication_monitoring", "action"),
    FeatureItem("web.rail_car_network_point_table_write", "在线列车车内通信点表维护（Web）", "web.train_communication_monitoring", "action"),
    FeatureItem("web.rail_car_network_point_table_export", "在线列车车内通信点表导出（Web）", "web.train_communication_monitoring", "action"),
    FeatureItem("web.rail_trackside_ap_business", "轨旁 AP 业务（Web）", "module.rail_transit", "page"),
