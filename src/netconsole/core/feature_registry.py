...
FEATURES: tuple[FeatureItem, ...] = (
    ...
    FeatureItem("web.rail_car_network_point_table_write", "车内通信点表维护（Web）", "web.train_communication_monitoring", "action"),
    FeatureItem("web.rail_car_network_point_table_export", "车内通信点表导出（Web）", "web.train_communication_monitoring", "action"),
