...
FEATURES: tuple[FeatureItem, ...] = (
    ...
    FeatureItem("web.device_management_write", "设备管理写操作（Web）", "web.device_management", "action", default_visible=False, default_enabled=False, default_client_package=False, status=FeatureStatus.DEVELOPMENT),
    FeatureItem("web.device_management_collect", "设备采集与诊断（Web）", "web.device_management", "action", default_visible=False, default_enabled=False, default_client_package=False, status=FeatureStatus.DEVELOPMENT),
    FeatureItem("web.device_management_import", "设备导入（Web）", "web.device_management", "action", default_visible=False, default_enabled=False, default_client_package=False, status=FeatureStatus.DEVELOPMENT),
    FeatureItem("web.device_management_export", "设备导出（Web）", "web.device_management", "action", default_visible=False, default_enabled=False, default_client_package=False, status=FeatureStatus.DEVELOPMENT),
    FeatureItem("web.device_management_desktop", "设备桌面联动（Web）", "web.device_management", "action", default_visible=False, default_enabled=False, default_client_package=False, status=FeatureStatus.DEVELOPMENT),
