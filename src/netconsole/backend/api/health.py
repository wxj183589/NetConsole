...
def health(request: Request) -> HealthResponse:
    ...
    return health_response(
        ...
        build_number=int(metadata.get("build_number") or 0),
        file_version=str(metadata.get("file_version") or f"{APP_VERSION.removeprefix('v')}.0"),
...
def health_response(
    ...
    *,
    ...
    build_number: int = 0,
    file_version: str = f"{APP_VERSION.removeprefix('v')}.0",
