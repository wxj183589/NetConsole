...
class ExternalTerminalSettingsDialog(QDialog):
    def __init__(self, i18n: I18n, settings: SettingsStore, parent=None) -> None:
        ...
        self.powershell_path = QLineEdit(str(settings.get_value("external_terminal/powershell_path", "") or ""))
        ...
        self.legacy_ssh_compatibility = QCheckBox(self.i18n.t("external_terminal.legacy_ssh_compatibility"))
        self.legacy_ssh_compatibility.setChecked(bool(settings.get_value("external_terminal/legacy_ssh_compatibility", True)))
        self.legacy_ssh_extended_compatibility = QCheckBox(self.i18n.t("external_terminal.legacy_ssh_extended_compatibility"))
        self.legacy_ssh_extended_compatibility.setChecked(bool(settings.get_value("external_terminal/legacy_ssh_extended_compatibility", False)))
        ...
        form.addRow(self.i18n.t("external_terminal.powershell_path"), self._path_row(self.powershell_path, "exe"))
        form.addRow("", self.pass_password)
        form.addRow("", self.legacy_ssh_compatibility)
        form.addRow("", self.legacy_ssh_extended_compatibility)
    ...
    def _save(self) -> None:
        ...
        self.settings.set_value("external_terminal/powershell_path", self.powershell_path.text().strip())
        self.settings.set_value("external_terminal/pass_password", self.pass_password.isChecked())
        self.settings.set_value("external_terminal/legacy_ssh_compatibility", self.legacy_ssh_compatibility.isChecked())
        self.settings.set_value("external_terminal/legacy_ssh_extended_compatibility", self.legacy_ssh_extended_compatibility.isChecked())
        self.accept()
