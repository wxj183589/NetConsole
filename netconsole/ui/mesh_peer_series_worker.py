...
class MeshPeerSeriesWorker(QThread):
    ...
    def __init__(self, db_path: Path, peer_mac: str, radio: int | None = None, session_id: str | None = None, parent=None, anchor_link_id: int | None = None, source_file_id: int | str | None = None) -> None:
