...
ONLINE_MR_ANALYSIS_TAB_INDEX = 5
...
class RailTransitPage(QWidget):
    def __init__(self, repository: DeviceRepository, i18n: I18n, site_name: str, paths: PathResolver) -> None:
        ...
        self.online_mr_analysis_placeholder = QWidget()
        ...
        self.tabs.addTab(self.online_mr_analysis_placeholder, "")
    ...
    def refresh_current_async_or_lazy(self, force_if_empty: bool = False) -> None:
        ...
        elif self.tabs.currentIndex() == ONLINE_MR_ANALYSIS_TAB_INDEX:
    ...
    def on_tab_changed(self, index: int) -> None:
        if index == ONLINE_MR_COLLECTION_TAB_INDEX:
            self._ensure_online_mr_page()
        elif index == ONLINE_MR_ANALYSIS_TAB_INDEX:
            self._ensure_online_mr_analysis_page()
        self.refresh_current_async_or_lazy()
    ...
    def set_repository(self, repository: DeviceRepository, site_name: str) -> None:
        ...
        if self.online_mr_analysis_page is not None:
            self.online_mr_analysis_page.set_repository(repository, site_name)
    ...
    def set_site(self, site_name: str) -> None:
        ...
        if self.online_mr_analysis_page is not None:
            self.online_mr_analysis_page.set_site(site_name)
    ...
    def retranslate(self) -> None:
        ...
        self.tabs.setTabText(ONLINE_MR_ANALYSIS_TAB_INDEX, self.i18n.t("rail_transit.online_mr_collection_analysis"))
        ...
        if self.online_mr_analysis_page is not None:
            self.online_mr_analysis_page.retranslate()
    ...
    def _ensure_online_mr_analysis_page(self) -> None:
        ...
        self.tabs.blockSignals(True)
        try:
            self.tabs.removeTab(ONLINE_MR_ANALYSIS_TAB_INDEX)
            self.tabs.insertTab(ONLINE_MR_ANALYSIS_TAB_INDEX, self.online_mr_analysis_page, self.i18n.t("rail_transit.online_mr_collection_analysis"))
            self.tabs.setCurrentIndex(ONLINE_MR_ANALYSIS_TAB_INDEX)
        finally:
            self.tabs.blockSignals(False)
