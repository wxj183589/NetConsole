...
本文定义 Electron-only 架构中的后台任务边界。旧 QThread/QWidget 规范已经退出活动架构；历史原文由 Git 保存，当前实现以 [Job Center](./README.md)、[导出进程规范](../export/PROCESS_POLICY.md)和[开发规则](../DEVELOPMENT_RULES.md)为准。
