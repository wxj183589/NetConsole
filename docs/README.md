...
| [轨旁 AP 管理 VLAN 分组规划](AP_MANAGEMENT_VLAN_GROUPS.md) | 三种规划方式、分组、地址、点表、迁移和 PVID 核验 | 轨旁 AP/Core/API/Vue 开发 | VLAN Planning Service、Repository、API 与 Vue | 分组规则、地址、点表、模板、迁移或 PVID 语义变化 |
