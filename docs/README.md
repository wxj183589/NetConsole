...
| [局点数据保留与清理](storage/SITE_RETENTION.md) | 局点扫描、备份归档、Online MR raw、任务事件和删除保护 | Storage/Job/Online MR/Web 开发 | `services/site_retention.py`、Site Storage API、Settings | 保留策略、候选证据、执行或保护边界变化 |
