...
- 生产详情 Command Profile：`zte.zxr10.switch.generic.device-inventory.v2`
...
| 光模块详情 | `DOCUMENT_SAMPLE_ONLY` | 尚未执行 `show opticalinfo <interface>` |
...
3. 采集 `show opticalinfo <interface>` 详情脱敏样本。
