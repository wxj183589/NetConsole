...
- Online MR 在 `ONLINE_MR_WEB_CONTROL_ENABLED=1` 时提供 LOCAL start 和 normal stop；控制路由额外要求 Desktop 模式、严格 `127.0.0.1` 与已认证短期 Cookie。没有 Web 强停、Agent 启停、解析、报告、删除、重试或命令 API；
