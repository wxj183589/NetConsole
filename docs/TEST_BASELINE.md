...
NetConsole 测试按风险等级、共享契约和消费者选择，不按历史 Bug 数量增长。详细风险与 Consumer Matrix 见 [Change Impact Framework](development/CHANGE_IMPACT_FRAMEWORK.md)，测试压缩候选见 [Test Asset Audit](development/TEST_ASSET_AUDIT.md)。
