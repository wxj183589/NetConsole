...
export interface TracksideApBusinessRow {
  ...
  ap_uuid: string; ap_mac: string; ap_name: string; model?: string; ap_optical_applicable?: boolean; ap_terminal_device_uuid?: string; ap_terminal_available?: boolean; ap_terminal_unavailable_reason?: string; ap_rx_power: unknown; ap_tx_power: unknown
