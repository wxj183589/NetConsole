...
export interface MeshAnalysisSession {
  ...
  associated_online_mr_session_id: string | null
  task_id: string | null
  report_count: number
...
export interface MeshAlignmentPoint { timestamp: string; peer_ap_name: string | null; peer_ap_mac: string | null; rssi: number | null; fping_rtt_ms: number | null; fping_loss_percent: number | null; iperf_mbps: number | null; switch_event: string | null; station: string | null; section: string | null }
export interface MeshAlignment { associated_online_mr_session_id: string | null; transient: boolean; items: MeshAlignmentPoint[]; message: string }
