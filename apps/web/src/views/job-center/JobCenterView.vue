...
onMounted(() => {
  ...
  if (['devices', 'ac', 'rail', 'config', 'files'].includes(module)) moduleFilter.value = module
    ...
    <div class="content-card job-table-card">
      <div class="job-toolbar">
        ...
        <div class="job-toolbar-actions">
          ...
          <el-select v-model="moduleFilter" style="width: 135px"><el-option label="全部模块" value="all" /><el-option label="设备管理" value="devices" /><el-option label="AC 管理" value="ac" /><el-option label="轨道交通" value="rail" /><el-option label="配置采集" value="config" /><el-option label="文件管理" value="files" /></el-select>
