...
export const navigationRegistry: NavigationItem[] = [
  ...
  item({ navigation_id: 'rail', title: '轨道交通', feature_id: 'module.rail_transit', order: 40, icon: 'rail', qt_page_id: 'rail_transit', qt_feature_id: 'module.rail_transit', parity_state: 'PARTIAL', desktop_only: false, internal_only: false, implemented: true, children: [
    ...
    item({ navigation_id: 'rail.train-communication', title: '在线列车车地通信检测', route_name: 'train-communication', route_path: '/rail-transit/train-communication', feature_id: 'web.train_communication_monitoring', parent_id: 'rail', order: 50, icon: 'rail', parity_state: 'PARTIAL', desktop_only: false, internal_only: false, implemented: true }),
    ...
    item({ navigation_id: 'rail.trackside-ap-plan', title: '轨旁 AP 规划', route_name: 'rail-trackside-ap-plan', route_path: '/rail-transit/trackside-ap-plan', feature_id: 'web.rail_trackside_ap_plan', parent_id: 'rail', order: 65, icon: 'rail', qt_feature_id: 'ac.trackside_ap_plan', parity_state: 'PARTIAL', desktop_only: false, internal_only: false, implemented: true }),
  ...
  item({ navigation_id: 'config', title: '配置采集中心', route_name: 'config-collection', route_path: '/config-center', feature_id: 'web.config_collection', order: 50, icon: 'config', qt_page_id: 'config_collection', qt_feature_id: 'module.config_collection', parity_state: 'IMPLEMENTED_UNVERIFIED', desktop_only: false, internal_only: false, implemented: true }),
  item({ navigation_id: 'files', title: '文件管理', route_name: 'file-management', route_path: '/file-manager', feature_id: 'web.file_management', order: 60, icon: 'files', qt_page_id: 'file_management', qt_feature_id: 'module.file_management', parity_state: 'IMPLEMENTED_UNVERIFIED', desktop_only: false, internal_only: false, implemented: true }),
  item({ navigation_id: 'network', title: '网络工具', feature_id: 'module.network_tools', order: 70, icon: 'network', qt_page_id: 'network_tools', qt_feature_id: 'module.network_tools', parity_state: 'PARTIAL', desktop_only: false, internal_only: false, implemented: true, children: [
    ...
    item({ navigation_id: 'network.wireless-scan', title: '无线扫描', route_name: 'network-tools-wireless-scan', route_path: '/network-tools/wireless-scan', feature_id: 'web.network_tools_wireless_scan', parent_id: 'network', order: 30, icon: 'network', qt_feature_id: 'network_tools.wireless_scan', parity_state: 'REAL_DEVICE_PENDING', desktop_only: false, internal_only: false, implemented: true }),
  ] }),
  ...
  item({ navigation_id: 'command-reference', title: '命令说明', route_name: 'command-reference', route_path: '/command-reference', feature_id: 'web.command_reference', order: 100, icon: 'system', qt_page_id: 'command_reference', qt_feature_id: 'module.command_reference', parity_state: 'PARTIAL', desktop_only: false, internal_only: false, implemented: true }),
  item({ navigation_id: 'logs', title: '日志中心', route_name: 'logs', route_path: '/logs', feature_id: 'web.logs', order: 110, icon: 'system', qt_page_id: 'logs', qt_feature_id: 'module.logs', parity_state: 'IMPLEMENTED_UNVERIFIED', desktop_only: false, internal_only: false, implemented: true }),
