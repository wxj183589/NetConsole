...
export const navigationRegistry: NavigationItem[] = [
  ...
  item({ navigation_id: 'tools', title: '工具集', order: 70, icon: 'tools', legacy_page_id: 'tools', legacy_feature_id: 'module.tools', parity_state: 'PARTIAL', desktop_only: false, internal_only: false, implemented: true, children: [
    item({ navigation_id: 'tools.traffic', title: '流量测试', route_name: 'tools-traffic', route_path: '/tools/traffic', feature_id: 'network_tools.traffic', parent_id: 'tools', order: 10, icon: 'network', legacy_feature_id: 'network_tools.traffic', parity_state: 'PARTIAL', desktop_only: false, internal_only: false, implemented: true }),
    item({ navigation_id: 'tools.connectivity', title: '小工具与连通性检测', route_name: 'tools-connectivity', route_path: '/tools/connectivity', feature_id: 'web.network_tools_toolbox', parent_id: 'tools', order: 20, icon: 'network', legacy_feature_id: 'network_tools.toolbox', parity_state: 'PARTIAL', desktop_only: false, internal_only: false, implemented: true }),
    item({ navigation_id: 'tools.wireless-scan', title: '无线扫描', route_name: 'tools-wireless-scan', route_path: '/tools/wireless-scan', feature_id: 'web.network_tools_wireless_scan', parent_id: 'tools', order: 30, icon: 'network', legacy_feature_id: 'network_tools.wireless_scan', parity_state: 'REAL_DEVICE_PENDING', desktop_only: false, internal_only: false, implemented: true }),
    item({ navigation_id: 'tools.network-components', title: '网络测试组件', route_name: 'tools-network-components', route_path: '/tools/network-components', feature_id: 'web.network_test_components', parent_id: 'tools', order: 40, icon: 'tools', parity_state: 'IMPLEMENTED_UNVERIFIED', desktop_only: true, internal_only: false, implemented: true }),
  ] }),
