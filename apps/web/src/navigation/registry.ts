...
export const navigationRegistry: NavigationItem[] = [
  ...
  item({ navigation_id: 'ac', title: 'AC 管理', feature_id: 'module.ac', order: 30, icon: 'ac', legacy_page_id: 'ac', legacy_feature_id: 'module.ac', parity_state: 'PARTIAL', desktop_only: false, internal_only: false, implemented: true, children: [
    item({ navigation_id: 'ac.trackside-plan', title: '轨旁 AP 规划', route_path: '/ac-management/trackside-plan', feature_id: 'web.ac_trackside_ap_plan', parent_id: 'ac', order: 10, icon: 'ac', legacy_feature_id: 'ac.trackside_ap_plan', parity_state: 'NOT_STARTED', desktop_only: false, internal_only: false, implemented: false }),
    ...
    item({ navigation_id: 'ac.optical', title: '光衰', route_name: 'ac-optical', route_path: '/ac-management/optical', feature_id: 'web.ac_optical', parent_id: 'ac', order: 40, icon: 'ac', legacy_feature_id: 'ac.fit_ap_optical', parity_state: 'REAL_DEVICE_PENDING', desktop_only: false, internal_only: false, implemented: true }),
  ...
  item({ navigation_id: 'rail', title: '轨道交通', feature_id: 'module.rail_transit', order: 40, icon: 'rail', legacy_page_id: 'rail_transit', legacy_feature_id: 'module.rail_transit', parity_state: 'PARTIAL', desktop_only: false, internal_only: false, implemented: true, children: [
    ...
    item({ navigation_id: 'rail.car-network-diagnostic', title: '车内通信检测', route_name: 'rail-car-network-diagnostic', route_path: '/rail-transit/car-network-diagnostic', feature_id: 'web.rail_car_network_diagnostic', parent_id: 'rail', order: 40, icon: 'rail', legacy_feature_id: 'rail.car_network_diagnostic', parity_state: 'PARTIAL', desktop_only: false, internal_only: false, implemented: true }),
