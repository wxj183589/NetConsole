...
export const navigationRegistry: NavigationItem[] = [
  ...
  item({ navigation_id: 'command-reference', title: '命令说明', route_path: '/command-reference', feature_id: 'web.command_reference', order: 100, icon: 'system', qt_page_id: 'command_reference', qt_feature_id: 'module.command_reference', parity_state: 'PARTIAL', desktop_only: false, internal_only: false, implemented: false }),
