...
export const navigationRegistry: NavigationItem[] = [
  ...
  item({ navigation_id: 'files', title: '文件管理', route_name: 'file-management', route_path: '/file-manager', feature_id: 'web.file_management', order: 60, icon: 'files', qt_page_id: 'file_management', qt_feature_id: 'module.file_management', parity_state: 'PARTIAL', desktop_only: false, internal_only: false, implemented: true }),
