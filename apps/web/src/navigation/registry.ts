...
export const navigationRegistry: NavigationItem[] = [
  ...
  item({ navigation_id: 'ac', title: 'AC 管理', feature_id: 'module.ac', order: 30, icon: 'ac', qt_page_id: 'ac', qt_feature_id: 'module.ac', parity_state: 'READ_ONLY', desktop_only: false, internal_only: false, implemented: true, children: [
    ...
    item({ navigation_id: 'ac.extensions', title: 'AP 扩展信息', route_path: '/ac-management/extensions', feature_id: 'web.ac_extensions', parent_id: 'ac', order: 50, icon: 'ac', qt_feature_id: 'ac.fit_ap_extensions', parity_state: 'NOT_STARTED', desktop_only: false, internal_only: false, implemented: false }),
  ...
  item({ navigation_id: 'rail', title: '轨道交通', feature_id: 'module.rail_transit', order: 40, icon: 'rail', qt_page_id: 'rail_transit', qt_feature_id: 'module.rail_transit', parity_state: 'READ_ONLY', desktop_only: false, internal_only: false, implemented: true, children: [
    ...
    item({ navigation_id: 'rail.car-network-diagnostic', title: '车内通信检测', route_path: '/rail-transit/car-network-diagnostic', feature_id: 'web.rail_car_network_diagnostic', parent_id: 'rail', order: 40, icon: 'rail', qt_feature_id: 'rail.car_network_diagnostic', parity_state: 'NOT_STARTED', desktop_only: false, internal_only: false, implemented: false }),
