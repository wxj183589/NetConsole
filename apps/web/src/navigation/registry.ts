...
export const navigationRegistry: NavigationItem[] = [
  ...
  item({ navigation_id: 'rail', title: '轨道交通', feature_id: 'module.rail_transit', order: 40, icon: 'rail', qt_page_id: 'rail_transit', qt_feature_id: 'module.rail_transit', parity_state: 'READ_ONLY', desktop_only: false, internal_only: false, implemented: true, children: [
    ...
    item({ navigation_id: 'rail.car-network-diagnostic', title: '车内通信检测', route_name: 'rail-car-network-diagnostic', route_path: '/rail-transit/car-network-diagnostic', feature_id: 'web.rail_car_network_diagnostic', parent_id: 'rail', order: 40, icon: 'rail', qt_feature_id: 'rail.car_network_diagnostic', parity_state: 'FAKE', desktop_only: false, internal_only: false, implemented: true }),
    ...
    item({ navigation_id: 'rail.online-mr', title: '车载 MR 实时收集', route_name: 'online-mr-realtime', route_path: '/rail-transit/online-mr', feature_id: 'web.online_mr_realtime', parent_id: 'rail', order: 80, icon: 'rail', qt_feature_id: 'rail.online_mr_collection', parity_state: 'FAKE', desktop_only: false, internal_only: false, implemented: true }),
