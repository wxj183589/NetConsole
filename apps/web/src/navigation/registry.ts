...
export const navigationRegistry: NavigationItem[] = [
  ...
  item({ navigation_id: 'devices', title: '设备管理', route_name: 'device-management', route_path: '/network/devices', feature_id: 'web.device_management', order: 20, icon: 'devices', qt_page_id: 'devices', qt_feature_id: 'module.devices', parity_state: 'PREVIEW_ONLY', desktop_only: false, internal_only: false, implemented: true }),
  item({ navigation_id: 'ac', title: 'AC 管理', feature_id: 'module.ac', order: 30, icon: 'ac', qt_page_id: 'ac', qt_feature_id: 'module.ac', parity_state: 'READ_ONLY', desktop_only: false, internal_only: false, implemented: true, children: [
    ...
    item({ navigation_id: 'ac.fit-aps', title: 'FIT-AP 资源', route_name: 'ac-fit-aps', route_path: '/ac-management/fit-aps', feature_id: 'web.ac_fit_ap_resources', parent_id: 'ac', order: 30, icon: 'ac', qt_feature_id: 'ac.fit_ap_resources', parity_state: 'READ_ONLY', desktop_only: false, internal_only: false, implemented: true }),
    item({ navigation_id: 'ac.optical', title: '光衰', route_path: '/ac-management/optical', feature_id: 'web.ac_optical', parent_id: 'ac', order: 40, icon: 'ac', qt_feature_id: 'ac.fit_ap_optical', parity_state: 'NOT_STARTED', desktop_only: false, internal_only: false, implemented: false }),
    item({ navigation_id: 'ac.extensions', title: 'AP 扩展信息', route_name: 'ac-extensions', route_path: '/ac-management/extensions', feature_id: 'web.ac_extensions', parent_id: 'ac', order: 50, icon: 'ac', qt_feature_id: 'ac.fit_ap_extensions', parity_state: 'FAKE_ACCEPTED', desktop_only: false, internal_only: false, implemented: true }),
    item({ navigation_id: 'ac.mesh-links', title: 'Mesh-Link 在线监控', route_name: 'ac-mesh-links', route_path: '/ac-management/mesh-links', feature_id: 'web.ac_mesh_links', parent_id: 'ac', order: 60, icon: 'ac', parity_state: 'CONTROLLED_WRITE', desktop_only: false, internal_only: false, implemented: true }),
  ...
  item({ navigation_id: 'rail', title: '轨道交通', feature_id: 'module.rail_transit', order: 40, icon: 'rail', qt_page_id: 'rail_transit', qt_feature_id: 'module.rail_transit', parity_state: 'READ_ONLY', desktop_only: false, internal_only: false, implemented: true, children: [
    ...
    item({ navigation_id: 'rail.base-data', title: '基础资料', route_name: 'rail-transit-base-data', route_path: '/rail-transit/base-data', feature_id: 'web.rail_transit_base_data', parent_id: 'rail', order: 20, icon: 'rail', parity_state: 'PREVIEW_ONLY', desktop_only: false, internal_only: false, implemented: true }),
    item({ navigation_id: 'rail.train-online', title: '列车在线情况', route_path: '/rail-transit/train-online', feature_id: 'web.rail_train_online', parent_id: 'rail', order: 30, icon: 'rail', qt_feature_id: 'rail.train_online', parity_state: 'NOT_STARTED', desktop_only: false, internal_only: false, implemented: false }),
    item({ navigation_id: 'rail.car-network-diagnostic', title: '车内通信检测', route_name: 'rail-car-network-diagnostic', route_path: '/rail-transit/car-network-diagnostic', feature_id: 'web.rail_car_network_diagnostic', parent_id: 'rail', order: 40, icon: 'rail', qt_feature_id: 'rail.car_network_diagnostic', parity_state: 'FAKE_ACCEPTED', desktop_only: false, internal_only: false, implemented: true }),
    ...
    item({ navigation_id: 'rail.trackside-ap-business', title: '轨旁 AP 业务', route_path: '/rail-transit/trackside-ap-business', feature_id: 'web.rail_trackside_ap_business', parent_id: 'rail', order: 60, icon: 'rail', qt_feature_id: 'rail.trackside_ap_business', parity_state: 'NOT_STARTED', desktop_only: false, internal_only: false, implemented: false }),
    item({ navigation_id: 'rail.mesh-analysis', title: 'MR 原始 MESH 日志分析', route_name: 'mesh-analysis', route_path: '/rail-transit/mesh-analysis', feature_id: 'web.mesh_analysis', parent_id: 'rail', order: 70, icon: 'rail', qt_feature_id: 'rail.raw_mesh_log_analysis', parity_state: 'READ_ONLY', desktop_only: false, internal_only: false, implemented: true }),
    item({ navigation_id: 'rail.online-mr', title: '车载 MR 实时收集', route_name: 'online-mr-realtime', route_path: '/rail-transit/online-mr', feature_id: 'web.online_mr_realtime', parent_id: 'rail', order: 80, icon: 'rail', qt_feature_id: 'rail.online_mr_collection', parity_state: 'FAKE_ACCEPTED', desktop_only: false, internal_only: false, implemented: true }),
    item({ navigation_id: 'rail.online-mr-analysis', title: '车载 MR 收集分析', route_path: '/rail-transit/online-mr-analysis', feature_id: 'web.online_mr_analysis', parent_id: 'rail', order: 90, icon: 'rail', qt_feature_id: 'rail.online_mr_analysis', parity_state: 'NOT_STARTED', desktop_only: false, internal_only: false, implemented: false }),
  ] }),
  item({ navigation_id: 'config', title: '配置采集中心', route_name: 'config-collection', route_path: '/config-center', feature_id: 'web.config_collection', order: 50, icon: 'config', qt_page_id: 'config_collection', qt_feature_id: 'module.config_collection', parity_state: 'CONTROLLED_WRITE', desktop_only: false, internal_only: false, implemented: true }),
  ...
  item({ navigation_id: 'network', title: '网络工具', feature_id: 'module.network_tools', order: 70, icon: 'network', qt_page_id: 'network_tools', qt_feature_id: 'module.network_tools', parity_state: 'CONTROLLED_WRITE', desktop_only: false, internal_only: false, implemented: true, children: [
    item({ navigation_id: 'network.traffic', title: '流量测试', route_name: 'network-tools-traffic', route_path: '/network-tools/traffic', feature_id: 'network_tools.traffic', parent_id: 'network', order: 10, icon: 'network', qt_feature_id: 'network_tools.traffic', parity_state: 'CONTROLLED_WRITE', desktop_only: false, internal_only: false, implemented: true }),
    item({ navigation_id: 'network.toolbox', title: '小工具与连通性检测', route_name: 'network-tools-toolbox', route_path: '/network-tools/toolbox', feature_id: 'web.network_tools_toolbox', parent_id: 'network', order: 20, icon: 'network', qt_feature_id: 'network_tools.toolbox', parity_state: 'CONTROLLED_WRITE', desktop_only: false, internal_only: false, implemented: true }),
  ...
  item({ navigation_id: 'tasks', title: '任务中心', route_name: 'tasks', route_path: '/tasks', feature_id: 'web.job_center', order: 80, icon: 'tasks', parity_state: 'CONTROLLED_WRITE', desktop_only: false, internal_only: false, implemented: true }),
  item({ navigation_id: 'agents', title: 'Agent 管理', route_name: 'agents', route_path: '/agents', feature_id: 'web.agent_management', order: 90, icon: 'agent', parity_state: 'CONTROLLED_WRITE', desktop_only: false, internal_only: false, implemented: true }),
