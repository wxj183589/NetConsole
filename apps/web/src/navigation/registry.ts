...
export const navigationRegistry: NavigationItem[] = [
  ...
  item({ navigation_id: 'config', title: '配置采集中心', route_name: 'config-collection', route_path: '/config-center', feature_id: 'web.config_collection', order: 50, icon: 'config', qt_page_id: 'config_collection', qt_feature_id: 'module.config_collection', parity_state: 'REAL_DEVICE_PENDING', desktop_only: false, internal_only: false, implemented: true }),
