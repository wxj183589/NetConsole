...
export const appRoutes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      { path: 'rail-transit/car-network-diagnostic', name: 'rail-car-network-diagnostic', component: () => import('../views/rail-transit/RailTransitWebParityView.vue'), meta: { navigationId: 'rail.car-network-diagnostic', featureId: 'web.rail_car_network_diagnostic', moduleId: 'rail', title: '轨道交通 / 车内通信检测', desktopOnly: false } },
