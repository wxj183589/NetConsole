...
export const appRoutes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'rail-transit/car-network-diagnostic', name: 'rail-car-network-diagnostic', redirect: { name: 'train-communication' }, meta: { featureId: 'web.train_communication_monitoring', moduleId: 'rail', title: '轨道交通 / 在线列车车内通信检测', desktopOnly: false, hiddenRoute: true } },
      { path: 'rail-transit/train-communication', name: 'train-communication', component: () => import('../views/rail-transit/TrainCommunicationView.vue'), meta: { navigationId: 'rail.train-communication', featureId: 'web.train_communication_monitoring', moduleId: 'rail', title: '轨道交通 / 在线列车车内通信检测', desktopOnly: false } },
