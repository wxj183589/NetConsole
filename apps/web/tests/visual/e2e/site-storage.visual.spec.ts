...
const activeSite = {
  ...
  path: 'D:\\NetConsoleTestData\\visual\\sites\\line-10',
...
const legacySite = {
  ...
  line_name: null,
  project_type: null,
  path: 'D:\\NetConsoleTestData\\visual\\sites\\历史二号线局点',
  active: false,
...
async function mockSiteStorage(page: Page): Promise<void> {
  ...
  await page.route('**/api/v1/storage/data-root', (route) => route.fulfill({
    contentType: 'application/json',
    body: JSON.stringify({
      data_root: 'D:\\NetConsoleTestData\\visual',
      default_data_root: 'D:\\NetConsoleTestData\\visual',
      site_count: 2,
