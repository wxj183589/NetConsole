...
function desktopRendererBuildMetaPlugin() {
  return {
    name: 'netconsole-desktop-renderer-build-meta',
    closeBundle() {
      ...
      writeFileSync(
        resolve(projectRoot, 'apps/desktop_renderer/dist/desktop-renderer-build-meta.json'),
...
export default defineConfig({
  ...
  plugins: [
    ...
    desktopRendererBuildMetaPlugin(),
  ],
  build: {
    outDir: 'dist',
    emptyOutDir: true,
