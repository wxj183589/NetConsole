...
export interface FileDownloadResult {
  ...
  mesh_import_status: '' | 'pending' | 'running' | 'completed' | 'duplicate' | 'failed' | 'rebuild_required' | 'repair_failed' | 'waiting_repair' | 'repairing'
  mesh_import_task_id?: string
  mesh_profile_id?: string
