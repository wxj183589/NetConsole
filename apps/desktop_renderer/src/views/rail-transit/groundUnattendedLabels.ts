const statusLabels: Record<string, string> = {
  ...
  CORRUPT: '原始数据损坏',
  LOCAL_ADDRESS: '本机地址',
  EXTERNAL_CONFIRMED: '外部/NAT 地址，已确认',
  NOT_LOCAL: '当前地址不属于本机',
  EMPTY: '尚未配置',
  INVALID: '地址无效',
  LISTENING: '正在监听',
  NETCONSOLE_LISTENING: 'NetConsole 正在监听',
  AVAILABLE: '端口空闲',
  OCCUPIED_BY_OTHER: '端口被其他程序占用',
  ADDRESS_NOT_LOCAL: '监听地址不属于本机',
  ...
  NO_ACTIVE_LINK: '无主链路',
  BOTH_MATCHED: '两端已解析',
  OLD_ONLY_MATCHED: '仅原 AP 已解析',
  NEW_ONLY_MATCHED: '仅当前 AP 已解析',
  BOTH_NOT_FOUND: '两端未解析',
  OLD_CONFLICT: '原 AP 身份冲突',
  NEW_CONFLICT: '当前 AP 身份冲突',
  BOTH_CONFLICT: '两端 AP 身份冲突',
  INVALID_MAC: 'MAC 格式异常',
  NO_AP_ENDPOINT: '存在无主链路端点',
  ...
  FLAPPING: '频繁切换',
  NONE: '无',
  RECENT_CHANGE: '最近有配置变更',
  RADIO_DOWN: '射频关闭',
  RADIO_RECOVERED: '射频已恢复',
  FREQUENT_SWITCHING: 'SNMP 频繁控制',
  HIGH: '高置信度',
  MEDIUM: '中置信度',
  UNCONFIRMED: '未关联',
  CORRELATED: '已关联',
...
const eventLabels: Record<string, string> = {
  ...
  cfgman_snmp_change: '检测到 SNMP 配置变更',
  radio_interface_down: '射频接口关闭',
  radio_interface_up: '射频接口开启',
  radio_interface_recovered: '射频接口恢复',
  radio_interface_bounce: '射频接口短暂中断',
  radio_interface_flapping: '射频接口频繁切换',
  radio_snmp_down: 'SNMP 操作导致射频接口关闭',
  radio_snmp_up: 'SNMP 操作导致射频接口开启',
  radio_snmp_bounce: 'SNMP 操作触发射频接口短暂重启',
  radio_snmp_flapping: 'SNMP 射频控制频繁切换',
