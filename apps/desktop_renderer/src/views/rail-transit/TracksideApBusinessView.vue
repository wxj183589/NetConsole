...
const deviceTerminalFeatureEnabled = computed(() => isFeatureEnabled('capability.devices.desktop_actions'))
const fitApTerminalFeatureEnabled = computed(() => (
  isFeatureEnabled('capability.ac.external_terminal')
  && isFeatureEnabled('capability.desktop_native_integration')
))
const wpsSyncFeatureEnabled = computed(() => isFeatureEnabled('capability.trackside_ap.wps_sync'))
...
const updateFeatureEnabled = computed(() => isFeatureEnabled('capability.trackside_ap.update') && isFeatureEnabled('capability.rail_transit.task_control'))
