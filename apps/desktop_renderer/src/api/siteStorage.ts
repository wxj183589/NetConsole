...
export interface SiteRetentionReport {
  ...
  policy: {
    ...
    task_retention_status: 'LONG_TERM_MANUAL_DELETE' | 'CURRENT_STATE' | 'KEEP_LAST_10_EFFECTIVE' | string
    typed_task_retention_apply_enabled: boolean
    typed_task_retention_owner: string
    typed_task_retention_keep_per_scope: number
