...
const COORDINATED_EXPORTS: CoordinatedExportEntry[] = [
  ...
  entry('views/rail-transit/MeshAnalysisView.vue',
    ['rail.mesh_report', 'rail.mesh_link_details', 'rail.mesh_raw_links', 'rail.mesh_ap_coverage'],
    ['exportMeshAnalysisReport', 'exportMeshLinkDetails', 'exportMeshRawLinks', 'exportMeshApCoverage']),
  ...
  entry('views/system/SystemMaintenanceView.vue',
    ['system.logs', 'system.open_source_txt', 'system.open_source_xlsx', 'system.field_diagnostic'],
    ['startLogExport', 'startOpenSourceExport', 'startFieldDiagnostic']),
