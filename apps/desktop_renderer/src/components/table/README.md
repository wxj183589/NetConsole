...
```powershell
pnpm --dir apps/desktop_renderer exec vitest run src/components/table
pnpm --dir apps/desktop_renderer exec vue-tsc -b --pretty false
pnpm --dir apps/desktop_renderer test:visual
