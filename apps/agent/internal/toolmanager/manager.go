...
const iperfHint = "请将 iperf3.exe 及 cygwin1.dll、cygcrypto-3.dll、cygz.dll 放到 tools/windows-x64/iperf3/ 目录"
const fpingHint = "请将 fping.exe 和 cygwin1.dll 放到 tools/windows-x64/fping/ 目录"
const mrCollectorHint = "请将 netconsole-mr-collector.exe 放到 tools/windows-x64/mr_collector/ 目录"
