    ...
    *,
    ...
    return {
        ...
        "read_path": (
            "legacy_full"
            if layout
            in {"legacy_dual_full", "guarded_default", "task_results_dual_write"}
            else "task_results_read_through"
        ),
        "persisted_rollout_state": rollout_status["persisted_rollout_state"],
        "runtime_write_state": rollout_status["runtime_write_state"],
