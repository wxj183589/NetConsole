...
| `check_dynamic_chart_stability.py` | `apps/desktop_renderer/src/components` 下复用 `createTimeChartInitOptions` 的时间轴 Vue 组件；检查 dirty rectangle、ResizeObserver、实例释放、null gap 和 series 替换 | `DYNAMIC_CHART_STABILITY` |
