...
def main() -> int:
    ...
    parser.add_argument("--data-dir", type=Path, default=Path("data"), help="NetConsole data 目录，默认 ./data")
    parser.add_argument("--all-sites", action="store_true", help="升级 data/sites 下所有局点数据库")
